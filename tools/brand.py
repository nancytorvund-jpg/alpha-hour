...
DOCS = {
    ...
    "ask": dict(md="THE-ASK.md", out="the-ask.html", title="Alpha Hours: The Ask", eyebrow="The ask", date="August 28, 2026",
                 sub="Four decisions to launch Alpha Hours in New York on October 19, 2026: the Head, the Operations and Admin VP, the New York guide team, and $365,000 that returns $1,123,000 in Session 2, a 208 percent return in one session.",
                 cards=[("Head", "Nancy Wisniewski Torvund at $400K, owning the P&L, held to plan fill, site profit and re-enrollment."),
                        ...
                        ("208%", "return in Session 2 alone: $1,123,000 of site profit on the plan case, $758,000 net of the $365,000, by December 18."),
