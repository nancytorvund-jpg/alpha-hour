...
DOCS = {
    ...
    "ask": dict(md="THE-ASK.md", out="the-ask.html", title="Alpha Hours: The Ask", eyebrow="The ask", date="August 28, 2026",
                 sub="Four decisions to launch Alpha Hours in New York on October 19, 2026, and $365,000 that Session 2 returns as $423,000 at a quarter full, $1,123,000 on the plan, and $1,919,000 at capacity: the first step toward a national business worth $268M a year in revenue and $216M a year in net profit.",
                 cards=[("$365,000", "the investment: the $141K one-time launch budget plus the Head and VP, fully loaded, September 1 to December 18. The only money Alpha puts in."),
                        ("16% to 426%", "Session 2 return: conservative, a quarter full, $423,000 back; plan, 60 percent, $1,123,000 and 208 percent; aggressive, full, $1,919,000."),
                        ("$216M", "net profit a year for the whole country at capacity: 40 campuses, 11,908 children, $268M revenue, on about $2.7M of one-time launch cost."),
                        ("Head", "Nancy Wisniewski Torvund at $400K, owning the P&L, held to plan fill, site profit and re-enrollment."),
